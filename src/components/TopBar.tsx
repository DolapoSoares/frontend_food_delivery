...
import logo from "../../public/foodapplogo.svg";
import logosm from "../../public/foodapplogo.svg";
...
const TopBar: React.FC<TopBarProps> = ({ handleLogOut, toggleMobile }) => {
  ...
  // }, []);
  return (
    <div className="bg-white p-4 text-white fixed top-0 left-0 w-full shadow-2xl h-[60px] md:h-[80px] z-10">
